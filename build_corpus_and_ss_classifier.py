...
print('import stuff from build_corpus and ss classifier')
from semisuper import ss_model_selection, cleanup_corpora
print('from semisuper import ss_model_selection, cleanup_corpora')
from semisuper.loaders import load_pipeline
print('from semisuper.loaders import load_pipeline')
from semisuper.helpers import num_rows
print('from semisuper.helpers import num_rows')
from semisuper.loaders import abstracts2pmid_pos_sentence_title
print('from semisuper.loaders import abstracts2pmid_pos_sentence_title')
...
def train_pipeline(from_scratch=False, write=True, outpath=None, mode=None, ratio=1.0):
    ...
    if write or outpath:
        ...
        with open(outpath, "wb") as f:
            pickle.dump(best_pipeline, f, protocol=2)
